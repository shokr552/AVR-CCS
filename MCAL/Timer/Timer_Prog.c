...
u32 Timer2_U32_NumOfOV = 0;
u32 Timer2_U32_NumOfCM = 0;
...
static void (*Timer2_OV)(void) = NULL;
...
void M_Timer_Void_Timer2SetTime(u32 Copy_U32_DesiredTime)
{
	u32 Local_U32_TickTime   = TIMER2_PRESCALER_DF / F_OSC; /* RESULT WILL BE IN MICRO SECONDS */
	u32 Local_U32_TotalTicks = (Copy_U32_DesiredTime * 1000) / Local_U32_TickTime;

#if   TIMER2_MODE   ==   NORMAL_MODE
	Timer2_U32_NumOfOV        = Local_U32_TotalTicks / 256;
	...
	OCR2 = Local_U8_DivisionValue - 1;
	Timer2_U32_NumOfCM = Local_U32_TotalTicks / Local_U8_DivisionValue;
#endif
}
...
void Timer2_SetCallBack(void (*p_fnc)(void))
{
	Timer2_CallBack = p_fnc;
}
...
ISR(TIMER2_COMP_vect)
{
	static u32 Local_U32_Counter = 0;
	Local_U32_Counter++;
	if(Local_U32_Counter == Timer2_U32_NumOfCM)
	{
		Timer2_CallBack();
		Local_U32_Counter = 0;
	}
...
ISR(TIMER2_OVF_vect)
{
	static u32 Local_U32_Counter = 0;
	Local_U32_Counter++;
	if(Local_U32_Counter == Timer2_U32_NumOfOV)
	{
		Timer2_OV();
		Local_U32_Counter = 0;
		TCNT2 = 256 - Timer2_U8_RemTicks;
